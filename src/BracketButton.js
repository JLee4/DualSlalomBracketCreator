...
export default class BracketButton extends Component {
  ...
  onClick_elButton = (ev) => {
    ...
    this.props.appActions.goToScreen('bracket', { ...this.props, transitionId: 'fadeIn' });
  ...
  render() {
    ...
    return (
      <div className="BracketButton" style={baseStyle}>
